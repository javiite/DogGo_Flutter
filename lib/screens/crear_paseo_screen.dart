...
class _CrearPaseoScreenState extends State<CrearPaseoScreen> {
  ...
  final List<Map<String, dynamic>> _duraciones = const [
    {'label': '30 min', 'val': 30},
    {'label': '45 min', 'val': 45},
    {'label': '1 hora', 'val': 60},
  ...
  Widget build(BuildContext context) {
    final cargando = _cargandoPerros || _cargandoPaseadores;
    ...
    return Scaffold(
      ...
      floatingActionButton: cargando ? null : _botonConfirmar(),
    );
  }
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    backgroundColor: G.brand.withOpacity(.1),
  ...
  Widget _paseadorFijoCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: G.white,
        borderRadius: G.r16,
        border: Border.all(color: G.brand.withOpacity(.3)),
      ),
      child: Row(
        children: [
          CircleAvatar(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color:
                  _latitudRecogida == null ? G.ink2 : G.brand.withOpacity(.5),
            ),
            boxShadow: G.shadow1,
          ),
          child: Row(
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          disabledBackgroundColor: G.brand.withOpacity(.5),
          padding: const EdgeInsets.symmetric(vertical: 16),
          shape: const RoundedRectangleBorder(borderRadius: G.r16),
          elevation: 4,
          shadowColor: G.brand.withOpacity(.5),
        ),
        child: _guardando
            ? const SizedBox(
                width: 20,
