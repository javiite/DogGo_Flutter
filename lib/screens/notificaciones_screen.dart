...
class _NotificacionesScreenState
  ...
  late final NotificationsController
      _controller;
  ...
  List<Widget> _buildNotificationGroups(
    ...
    for (final group
        in AppNotificationGroup.values) {
      final notifications =
          groups[group] ?? const [];
