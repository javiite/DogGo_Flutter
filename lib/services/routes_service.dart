...
class RoutesService {
  ...
  static Future<List<SavedDoggoRoute>>
  ...
  static Future<SavedDoggoRoute>
      getSavedRoute(int routeId) async {
    final response = await ApiService.getAuth(
    ...
    return SavedDoggoRoute.fromMap(
      _requireDataMap(body),
    );
  }
  ...
  static Future<SavedDoggoRoute>
      duplicateSavedRoute(int routeId) async {
    final response = await ApiService.postAuth(
  ...
  static Future<void> deleteSavedRoute(
    int routeId,
  ) async {
  ...
  static Future<PlannedDoggoRoute>
      assignSavedRoute({
    required int walkId,
    ...
    final body = _requireSuccess(
      response,
      fallbackMessage:
          'No se pudo asignar la ruta al paseo.',
    );

    return PlannedDoggoRoute.fromMap(
      _requireDataMap(body),
    );
  }
  ...
  static Future<PlannedDoggoRoute?>
      getPlannedRoute(int walkId) async {
    final response = await ApiService.getAuth(
      '/api/paseos/$walkId/ruta-planificada',
    );
    ...
    final body = _requireSuccess(
      response,
      fallbackMessage:
          'No se pudo consultar la ruta del paseo.',
    );
  ...
  static Future<void> removePlannedRoute(
    int walkId,
  ) async {
    final response = await ApiService.deleteAuth(
      '/api/paseos/$walkId/ruta-planificada',
    ...
    _requireSuccess(
      response,
      fallbackMessage:
          'No se pudo quitar la ruta del paseo.',
    );
  }
  ...
  static Map<String, dynamic> _requireDataMap(
    ...
    throw const ApiException(
      ...
      message:
          'El servidor devolvió una ruta incompleta.',
    );
  }
}